...
const RESOURCES = [
  ...
  { id: 'recurring_invoice',       label: '반복거래(입금)',       group: '일반회계 · 판매·수주(매출)' },
  ...
  { id: 'payment_run',             label: '매입 결제내역',   group: '일반회계 · 문서' },
  { id: 'purchase_status',         label: '매입 현황',       group: '일반회계 · 문서' },
  ...
  { id: 'finance_lending',         label: '대여금',         group: '재무관리' },
  { id: 'finance_note',            label: '어음',           group: '재무관리' },

...
const TEMPLATES = {
  item: {
    file: '품목_업로드_양식.xlsx',
    sheet: '품목',
    /* 중량·단가 단위가 빠져 있었다. 서버도 마법사도 받는 값인데 양식에만 없어서,
       ㎏당 단가로 파는 업종(금속·자재)은 품목을 올린 뒤 하나씩 열어 고쳐야 했다. */
    cols: ["품목코드", "품명", "유형", "분류", "규격", "단위", "매입가", "출고가", "중량", "단가 단위", "과세"],
    required: "품명",
    widths: [12, 28, 10, 14, 20, 8, 12, 12, 10, 10, 8],
    samples: [
      ["SW-001", "그룹웨어 구축", "서비스", "웹서비스", "1식", "식", "0", "12000000", "", "수량", "과세"],
      ["MT-100", "알루미늄 브라켓", "원재료", "가공품", "120×80×6t", "EA", "3500", "0", "1.8", "중량", "과세"],
    ],
    guide: [
      ["• 품명: 필수. 반드시 입력하세요."],
      ...
      ["• 중량: 단위당 중량. 소수도 됩니다(예: 1.8). 중량으로 팔지 않으면 비워두세요."],
      ["• 단가 단위: 단가를 무엇에 곱할지 — '수량'(기본) 또는 '중량'. ㎏당 단가로 파는 품목만 '중량'."],
    ],
  },
  fixed_asset: {

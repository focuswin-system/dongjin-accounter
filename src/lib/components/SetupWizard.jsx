...
/* 순서에 뜻이 있다. 앞의 것이 뒤의 것을 채워준다:
   ...
   기초 잔액 → 장부 시작일·그날 통장 잔액·그 전부터 있던 받을 돈·줄 돈(4단계). 계좌가 있어야 잔액을 넣는다
...
const STEPS = [
  ...
  {
    key: 'opening', label: '기초 잔액', route: 'settings_company',
    why: '쓰기 시작한 날(장부 시작일)을 정하고, 그날 통장 잔액과 그 전부터 있던 받을 돈·줄 돈을 넣어요. 그래야 잔액·미수금이 처음부터 맞아요.',
    done: (s) => s.booksStart > 0,
    doneText: () => '시작일 있음',
    optional: true,
  },
  {
  ...
  },
  {
    ...
    why: '팔거나 사는 것들. 등록해두면 청구서 품목·주문 단가가 자동으로 채워집니다.',
    done: (s) => s.items > 0,
